        ...
        child: Form(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                const Text('To register as Establishment please enter the needed information'),
                const Gap(12),
                TextFormField(
                ...
                TextFormField(
                  ...
                  decoration: setTextDecoration('Business/Establishment Name'),
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Required';
                    }
