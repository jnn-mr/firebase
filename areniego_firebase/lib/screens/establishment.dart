...
import 'package:areniego_firebase/screens/profile_establishment.dart';
import 'package:areniego_firebase/screens/home.dart';
...
void initState() {
  ...
  void scanQR(BuildContext context) async {
    ...
    String result = await FlutterBarcodeScanner.scanBarcode(lineColor, cancelButtonText, isShowFlashIcon, scanMode);
    print(result);
    ...
    if(result != '-1') {
      ...
      DocumentSnapshot userSnapshot = await FirebaseFirestore.instance.collection('users').doc(result).get();
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ProfileScreen(establishmentUid: FirebaseAuth.instance.currentUser!.uid)),
                );
              },
            ),
          ],
                          ...
                          title: FutureBuilder(
                            ...
                            builder: (context, snapshot) {
                              ...
                              if (!document.containsKey('firstname')) {
                                return Text(
                                    'Firstname not found in document');
                              }
                              return Text(
